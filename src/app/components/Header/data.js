const data = {
  en: {
    ...
    picture: {
      alt: 'This is me',
      src:
        'https://thechive.files.wordpress.com/2019/02/hiddenthings.jpg?quality=85&strip=info&w=600&h=450&crop=1',
    },
  },
  kr: {
    name: '아우렐 리야 카스파 비티 우트',
    contacts: {
      phone: {
        label: 'Phone:',
        value: '+37061529753',
